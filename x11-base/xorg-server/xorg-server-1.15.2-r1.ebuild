...
# $Header: /var/cvsroot/gentoo-x86/x11-base/xorg-server/xorg-server-1.15.2-r1.ebuild,v 1.9 2015/01/17 20:09:46 maekke Exp $
...
IUSE="${IUSE_SERVERS} ipv6 minimal nptl +opengl selinux +suid tslib +udev unwind"
