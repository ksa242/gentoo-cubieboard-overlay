...
# $Header: /var/cvsroot/gentoo-x86/media-libs/mesa/mesa-10.2.8.ebuild,v 1.9 2014/12/30 18:06:04 maekke Exp $
...
IUSE="${IUSE_VIDEO_CARDS}
	...
	opencl +opengl openvg osmesa pax_kernel openmax pic r600-llvm-compiler
	selinux +udev vdpau wayland xvmc xa kernel_FreeBSD kernel_linux"
...
DEPEND="${RDEPEND}
	...
	opengl? ( >=x11-proto/glproto-1.4.16-r1:=[${MULTILIB_USEDEP}] )
...
src_prepare() {
	...
	# make OpenGL headers optional, allow OpenGLES-only builds.
	epatch "${FILESDIR}"/${PN}-10.2-optional-opengl.patch
